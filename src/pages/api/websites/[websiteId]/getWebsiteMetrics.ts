    ...
    const formattedData = async (data: dataType, type: string) => {
      ...
      if (source) {
        return data.map((item: ItemType) => {
          ...
          switch (type) {
            case 'os':
              icon = `//umami.butlanys.de/images/os/${itemName}.png`;
              break;
            case 'browser':
              icon = `//umami.butlanys.de/images/browser/${itemName}.png`;
              break;
            case 'country':
              icon = `//umami.butlanys.de/images/country/${itemName}.png`;
              break;
            case 'device':
              icon = `//umami.butlanys.de/images/device/${itemName}.png`;
              break;
            default:
              icon = '';
              break;
